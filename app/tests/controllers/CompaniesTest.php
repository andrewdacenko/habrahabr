...
class CompaniesTest extends TestCase {
	...
	{
		$this->mock = m::mock('Eloquent', 'Company');
	...
	public function setUp()
	{
		...
		$this->attributes = Factory::company(['id' => 1]);
		$this->app->instance('Company', $this->mock);
	}
	...
	public function testUpdate()
	{
		...
		$this->validate(true);
		$this->call('PATCH', 'companies/1');

		$this->assertRedirectedTo('companies/1');
	}
